	...
	*/
	...
	function renderNode(node){
		...
		span_desc.addEventListener("dblclick", function(e){
			...
			let parentHasOnlyLeaf = node.getChildren().filter(child => !child.isLeaf()).length;
			if(typeof node_cur === "undefined" || !parentHasOnlyLeaf){
				return;
			}
		...
		if(node.isLeaf() && !TreeUtil.getProperty(node.getOptions(), "forceParent", false)){
			...
			if(parentHasOnlyLeaf) {
				...
				ret += '<span style="width:20px;height:20px;padding:0px 4px;"></span>';
			}
		...
		span_desc.querySelector(".tj_mod_icon") ? 
		span_desc.querySelector(".tj_mod_icon").addEventListener("click", function(e) {
			var cur_el = e.target;
...
const TreeUtil = {
	...
	default_open_icon: `<svg width="5" height="8" viewBox="0 0 5 8" fill="none" xmlns="http://www.w3.org/2000/svg" style="transform: rotate(90deg)">
	<path fill-rule="evenodd" clip-rule="evenodd" d="M0.136953 0.773268C-0.041582 0.600377 -0.0461578 0.315489 0.126733 0.136954C0.299624 -0.041582 0.584512 -0.0461578 0.763047 0.126733L3.94501 3.2081C3.95554 3.21713 3.96574 3.22673 3.97559 3.2369C4.0948 3.36 4.12963 3.53366 4.08125 3.68631C4.06091 3.75091 4.02563 3.81188 3.9753 3.86385C3.96726 3.87215 3.95898 3.88008 3.95047 3.88763L0.76333 6.97401C0.584795 7.1469 0.299907 7.14233 0.127016 6.96379C-0.0458749 6.78525 -0.041299 6.50037 0.137237 6.32748L3.00487 3.55051L0.136953 0.773268Z" fill="#BDBDBD"/>
	</svg>`,
	default_close_icon: `<svg width="5" height="8" viewBox="0 0 5 8" fill="none" xmlns="http://www.w3.org/2000/svg">
	<path fill-rule="evenodd" clip-rule="evenodd" d="M0.136953 0.773268C-0.041582 0.600377 -0.0461578 0.315489 0.126733 0.136954C0.299624 -0.041582 0.584512 -0.0461578 0.763047 0.126733L3.94501 3.2081C3.95554 3.21713 3.96574 3.22673 3.97559 3.2369C4.0948 3.36 4.12963 3.53366 4.08125 3.68631C4.06091 3.75091 4.02563 3.81188 3.9753 3.86385C3.96726 3.87215 3.95898 3.88008 3.95047 3.88763L0.76333 6.97401C0.584795 7.1469 0.299907 7.14233 0.127016 6.96379C-0.0458749 6.78525 -0.041299 6.50037 0.137237 6.32748L3.00487 3.55051L0.136953 0.773268Z" fill="#BDBDBD"/>
	</svg>`,
